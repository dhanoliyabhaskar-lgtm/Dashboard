...
const helpandfeedbackpage = document.querySelector('.helpandfeedback-page')
...
if (currentTheme == 2) {
    ...
    helpandfeedbackpage.style.backgroundColor = 'rgb(28, 30, 36)';
} else {
    ...
    helpandfeedbackpage.style.backgroundColor = 'white';
}
